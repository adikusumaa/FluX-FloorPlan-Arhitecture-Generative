...
if __name__ == "__main__":
    ...
    test_inputs = [
        ...
        "Balkon berada di sisi sudut barat laut. Berada di antara ruang utama dan ruang bersama. Ukuran 16x4 kaki persegi. Kamar mandi berada di sisi tengah timur. Ruangan ini berada di antara dapur dan ruang bersama. Ukuran 10x4 kaki persegi. Ruang bersama terletak di sisi timur laut. Berada di antara kamar mandi dan ruang utama. Ukuran 14x14 kaki persegi. Dapur berada di sudut tenggara. Berada di antara ruang penyimpanan dan kamar mandi. Ukuran 10x4 kaki persegi. Ruang tamu berada di sudut tenggara dan menghadap ke selatan. Terhubung dengan semua ruangan kecuali balkon. Ukuran 20x18 kaki persegi. Ruang utama terletak di sisi tengah barat. Ruangan ini berada di antara ruang tamu dan balkon. Ukuran 16x16 kaki persegi. Ruang penyimpanan berada di sudut tenggara. Berada di antara ruang tamu dan dapur. Ukuran 4x4 kaki persegi",
